...
namespace Server
{
    ...
    public class WorldBeforeSaveEventArgs : EventArgs
    {
        private readonly bool m_Msg;

        public bool Message => m_Msg;

        public WorldBeforeSaveEventArgs(bool msg)
        {
            m_Msg = msg;
        }
    }
    ...
    public class PartyChatEventArgs
    {
        ...
        public Mobile From => m_Mobile;
        public Mobile To => m_ToMobile;
        public string Speech => m_Speech;
    }
    ...
    public static class EventSink
    {
        ...
        public static event AfterWorldLoadEventHandler AfterWorldLoad;

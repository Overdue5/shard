...
namespace Server.Items
{
	public class TrashTalkingBarrel : Container, IChopable
	{
		...
		private static string[] trashWho = { "everyone", "people", "children", "sailors", "daemons", "priests", "men", "women", "righteous foll", "folk", "peasants", "kings", "tamers", "mages", "beggars", "jesters", "the blind", "the miserable", "the naked", "the flexible", "the poor", "dogs", "toads", "food", "chickens", "cows", "chairs", "barkeeps", "merchants" };
		...
		public TrashTalkingBarrel( Serial serial ) : base( serial )
		{
		}
		...
		{
			private TrashTalkingBarrel m_Barrel;

			public EmptyTimer( TrashTalkingBarrel barrel ) : base( TimeSpan.FromMinutes( 3.0 ) )
			{
				m_Barrel = barrel;

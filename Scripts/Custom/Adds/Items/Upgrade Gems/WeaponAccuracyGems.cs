			...
			public InternalTarget( AccuracyGem runeaug ) : base( 1, false, TargetFlags.None )
			{
		 	...
		 	{ 
					...
					{ 
                        ...
                        if (targeted is HellsHalberd || targeted is JudgementHammer || targeted is KissOfDeath || targeted is BloodTentacle || targeted is ForsakenOrnament || targeted is DwarfWarHammer || targeted is DwarvenBattleAxe || targeted is GoblinClooba || targeted is ApalalasClaw || targeted is SerpentsTongue || targeted is SkyfallLongsword || Weapon.LootType != LootType.Regular)
                        {
        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is BaseWeapon)
                {
                    ...
                    if (targeted is HellsHalberd || targeted is JudgementHammer || targeted is KissOfDeath || targeted is BloodTentacle || targeted is ForsakenOrnament || targeted is DwarfWarHammer || targeted is DwarvenBattleAxe || targeted is GoblinClooba || targeted is ApalalasClaw || targeted is SerpentsTongue || targeted is SkyfallLongsword)
                    {
                        from.SendMessage("This gem cannot be used on that.");
                    }

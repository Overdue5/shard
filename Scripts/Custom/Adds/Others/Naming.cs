...
namespace Server
{
    ...
    public class Naming
    {
        ...
        private class NamingGump : Gump
        {
            ...
            private static string m_Html = @"<basefont color=#FFFFFF>The name you have selected for your character isn't available. Deluxe ensures that all player names are unique to prevent confusion. Please select a new name for your character and press the OK button.<p>Thank you,<br>The Deluxe staff.";
            private static string m_Welcome = @"Welcome to Deluxe";
            ...
            private static string m_ThankYou = @"Thank you for choosing a different name. Welcome to Deluxe, {0}";

...
namespace Server.Engines.XmlSpawner2
{
	...
	public class XmlQuestLeaders
	{
		...
		public static void WriteQuestLeaderboardXml(string filename, int nranks)
		{
			...
			if(xf == null)
			{
				ConsoleLog.Write.Error("Error: unable to save XML quest leaderboard to {0}", dirname);
				return;
			}
		...
		public static void WriteQuestLeaderboardHtml(string filename, int nranks)
		{
			...
			if(sw == null)
			{
				ConsoleLog.Write.Error("Error: unable to save HTML quest leaderboard to {0}", dirname);
				return;
			}

            ...
            : base(0, 0)
        {
            ...
            if (File.Exists(path))
            {
                try
                {
                    ...
                    {
                        this.AddHtml(98, 179, 332, 285, @"<basefont color=black>...no NEWS at this time...</basefont>", (bool)false,
                            (bool)true);
                        sr.Close();
                    }
                }
                ...
                {
                    ConsoleLog.Write.Information("Announcements file error occurred");
    ...
    public class AnnouncementEditGump : Gump
    {
        ...
        public AnnouncementEditGump(int current) : base(0, 0)
        {
            ...
            if (File.Exists(path))
            {
                ...
                {
                    ConsoleLog.Write.Warning("Announcements file error occurred", e);
                }
            }
            else
            {

...
namespace Server.Misc
{
    public class NotorietyHandlers
    {
        ...
        public static bool Mobile_AllowBeneficial(Mobile from, Mobile target)
        {
            ...
            if (from is PlayerMobile && !from.IsInEvent && ((PlayerMobile)from).Young &&
        ...
        public static bool Mobile_AllowHarmful(Mobile from, Mobile target)
        {
            ...
            var cR = target.Region as CustomRegion;
            ...
            */
            ...
            if ((from is PlayerMobile && ((PlayerMobile)from).CheckYoungProtection(target)) ||
        ...
        public static int CorpseNotoriety(Mobile source, Corpse target)
        {
            ...
            {
                var src = source as PlayerMobile;
                var trg = target.Owner as PlayerMobile;
                var srcevent = src.CurrentEvent as BaseTeamGame;
                var trgevent = trg.CurrentEvent as BaseTeamGame;
                if (srcevent != null && trgevent != null)
                {
                    var srcteam = srcevent.GetTeam(source);
                    if (srcteam != null)
                    {
                        var trgteam = srcevent.GetTeam(target.Owner);
                        if (trgteam != null)
            ...
            {
                var pmTarget = (PlayerMobile)target.Owner;
                ...
                var targetGuild = GetGuildFor(target.Owner.Guild as Guild, target.Owner);
        ...
        public static int MobileNotoriety(Mobile source, Mobile target)
        {
            ...
            {
                var dm1 = Custom.PvpToolkit.PvpCore.GetPlayerStone(source);
                var dm2 = Custom.PvpToolkit.PvpCore.GetPlayerStone(target);

                return dm1 == dm2 ? Notoriety.Enemy : Notoriety.Invulnerable;
            }

            //Tournament
            if (Custom.PvpToolkit.Tournament.TournamentCore.IsInTournament(source) &&
                Custom.PvpToolkit.Tournament.TournamentCore.IsInTournament(target))
            {
                var stone1 = Custom.PvpToolkit.Tournament.TournamentCore.GetPlayerStone(source);
                var stone2 = Custom.PvpToolkit.Tournament.TournamentCore.GetPlayerStone(target);
            ...
            {
                var src = source as PlayerMobile;
                var trg = target as PlayerMobile;
                var srcevent = src.CurrentEvent as BaseTeamGame;
                var trgevent = trg.CurrentEvent as BaseTeamGame;
                if (srcevent != null && trgevent != null)
                {
                    ...
                    if (srcteam != null)
                    {
                        var trgteam = srcevent.GetTeam(target);
                        if (trgteam != null)
                            return srcteam == trgteam ? Notoriety.Ally : Notoriety.Enemy;
                    }
                }
